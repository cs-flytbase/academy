...
export function CourseCard({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 rounded-3xl bg-gradient-to-b from-[#1871d669] via-[#1A6ED0] to-[#1871d6] p-[0.5px]">
        {/* INNER CARD */}
        <Card className="h-full rounded-3xl overflow-hidden bg-gradient-to-b from-[#14171b] to-[#1a1e24] border-0 p-0 flex flex-col">
          ...
          {/* THUMBNAIL - With padding to match content */}
          <div className="relative w-full h-1/2 overflow-hidden flex-none px-4 pt-4">
            <div className="relative w-full h-full rounded-xl overflow-hidden">
              <Image
                ...
                priority
              />
              {/* Gradient overlay for better contrast and visual interest - lighter version */}
              <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-transparent to-[#14171b]/70" />
              ...
              <div className="absolute bottom-[.5] left-0 flex items-center justify-between gap-3 z-20 w-full px-1 ">
                ...
                <div>
                  <Button
                    ...
                    className={cn(
                      ...
                      "hover:bg-black/60 hover:border-[#3a8dff]/50 transition-all duration-300 cursor-pointer",
