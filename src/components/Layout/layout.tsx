              ...
              <div className="flex items-center space-x-8 ">
                ...
                <div className="relative group mx-5">
                  <div className="flex items-center cursor-pointer ">
                    <span className="text-sm md:text-sm font-bold">RESOURCES</span>
                ...
                <Link href="/assignment">
                  <span className="text-sm md:text-sm font-bold">CERTIFICATIONS</span>
                </Link>
                <Link href="/course">
                  <span className="text-sm md:text-sm font-bold">COURSES</span>
                </Link>
              </div>
