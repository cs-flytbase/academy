              ...
              <div className="flex items-center space-x-8 ">
                ...
                <div className="relative group mx-5">
                  <div className="flex items-center cursor-pointer ">
                    <span className="text-sm md:text-sm font-medium">Resources</span>
                ...
                <Link href="/assignment">
                  <span className="text-sm md:text-sm font-medium">Certifications</span>
                </Link>
                <Link href="/course">
                  <span className="text-sm md:text-sm font-medium">Courses</span>
                </Link>
              </div>
